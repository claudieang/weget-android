...
//        });
        ...
        bottomNavigationBar
                .addItem(new BottomNavigationItem(R.drawable.bt_visa, "位置").setActiveColor("#FF4081"))
                .addItem(new BottomNavigationItem(R.drawable.bt_jcb, "发现").setActiveColor("#FF4081"))
    ...
    */
    ...
    private void setDefaultFragment() {
        ...
        mLocationFragment = CreateRequestActivity.newInstance("位置");
